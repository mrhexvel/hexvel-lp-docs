...
export default function CommandCard({
  ...
  return (
    <Card title={title}>
      ...
      <CodeBlock className="mt-2 text-emerald-200 rounded-md text-sm">
      ...
      {example && (
        <Callout>
          <p className="text-sm text-emerald-200">{example}</p>
          {exampleSecond && (
            <p className="text-sm text-emerald-200">{exampleSecond}</p>
          )}
          {exampleThird && (
            <p className="text-sm text-emerald-200">{exampleThird}</p>
          )}
        </Callout>
      )}
    </Card>
